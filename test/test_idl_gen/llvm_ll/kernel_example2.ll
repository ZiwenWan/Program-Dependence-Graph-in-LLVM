; ModuleID = 'kernel_example2.c'
source_filename = "kernel_example2.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define void @register_device(%struct.device* %device_option) #0 !dbg !40 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.device** %device_option.addr, metadata !41, metadata !DIExpression()), !dbg !42
  ...
  %1 = load %struct.device*, %struct.device** %device_option.addr, align 8, !dbg !47
  %2 = load %struct.node*, %struct.node** %new_node, align 8, !dbg !48
  %dev = getelementptr inbounds %struct.node, %struct.node* %2, i32 0, i32 0, !dbg !49
  store %struct.device* %1, %struct.device** %dev, align 8, !dbg !50
...
!3 = !DIFile(filename: "kernel_example2.c", directory: "/home/yongzhe/llvm-versions/llvm-5.0/lib/Analysis/PDG/test/test_idl_gen")
!4 = !{}
!5 = !{!6, !23}
...
!28 = distinct !DIGlobalVariable(name: "dev2", scope: !2, file: !3, line: 85, type: !11, isLocal: true, isDefinition: true)
...
!41 = !DILocalVariable(name: "device_option", arg: 1, scope: !40, file: !3, line: 31, type: !10)
...
!100 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 92, type: !101, isLocal: false, isDefinition: true, scopeLine: 92, isOptimized: false, unit: !2, variables: !4)
!101 = !DISubroutineType(types: !102)
!102 = !{!21}
!103 = !DILocalVariable(name: "dev", scope: !100, file: !3, line: 93, type: !10)
!104 = !DILocation(line: 93, column: 21, scope: !100)
!105 = !DILocation(line: 94, column: 10, scope: !100)
!106 = !DILocation(line: 94, column: 5, scope: !100)
!107 = !DILocation(line: 95, column: 5, scope: !100)
!108 = !DILocation(line: 96, column: 5, scope: !100)
!109 = !DILocation(line: 97, column: 5, scope: !100)
!110 = !DILocation(line: 99, column: 11, scope: !100)
!111 = !DILocation(line: 99, column: 9, scope: !100)
!112 = !DILocation(line: 100, column: 10, scope: !100)
!113 = !DILocation(line: 100, column: 5, scope: !100)
!114 = !DILocation(line: 101, column: 11, scope: !100)
!115 = !DILocation(line: 101, column: 9, scope: !100)
!116 = !DILocation(line: 102, column: 10, scope: !100)
!117 = !DILocation(line: 102, column: 5, scope: !100)
!118 = !DILocation(line: 104, column: 5, scope: !100)
...
!126 = distinct !DISubprogram(name: "dev2_open", scope: !3, file: !3, line: 81, type: !15, isLocal: true, isDefinition: true, scopeLine: 81, flags: DIFlagPrototyped, isOptimized: false, unit: !2, variables: !4)
!127 = !DILocalVariable(name: "dev", arg: 1, scope: !126, file: !3, line: 81, type: !10)
!128 = !DILocation(line: 81, column: 38, scope: !126)
!129 = !DILocation(line: 82, column: 2, scope: !126)
!130 = !DILocation(line: 82, column: 7, scope: !126)
!131 = !DILocation(line: 82, column: 29, scope: !126)
!132 = !DILocation(line: 83, column: 1, scope: !126)
