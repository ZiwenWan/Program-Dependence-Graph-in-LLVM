; ModuleID = 'example.k3.c'
source_filename = "example.k3.c"
...
entry:
  ...
  store i32 1, i32* %devop_init_registered, align 8, !dbg !133
  ret void, !dbg !134
}
...
!3 = !DIFile(filename: "example.k3.c", directory: "/home/yongzhe/llvm-versions/llvm-5.0/lib/Analysis/PDG/test/test_idl_gen")
!4 = !{}
!5 = !{!6, !23}
...
!131 = !DILocation(line: 74, column: 2, scope: !128)
!132 = !DILocation(line: 74, column: 7, scope: !128)
!133 = !DILocation(line: 74, column: 29, scope: !128)
