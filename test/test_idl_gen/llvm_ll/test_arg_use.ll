...
entry:
  ...
  call void @agePtr(%struct.person* %p), !dbg !95
  ret i32 0, !dbg !96
}
...
!1 = !DIFile(filename: "test_arg_use.c", directory: "/home/yongzhe/llvm-versions/llvm-5.0/lib/Analysis/PDG/test/test_idl_gen")
!2 = !{}
...
!96 = !DILocation(line: 50, column: 5, scope: !86)
