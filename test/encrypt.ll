...
@.str = private unnamed_addr constant [12 x i8] c", welcome!\0A\00", align 1
@key = common global i8* null, align 8
@i = common global i32 0, align 4
@ciphertext = common global i8* null, align 8
@.str.1 = private unnamed_addr constant [17 x i8] c"Enter username: \00", align 1
@.str.2 = private unnamed_addr constant [5 x i8] c"%19s\00", align 1
@.str.3 = private unnamed_addr constant [18 x i8] c"Enter plaintext: \00", align 1
@.str.4 = private unnamed_addr constant [7 x i8] c"%1023s\00", align 1
@.str.5 = private unnamed_addr constant [14 x i8] c"Cipher text: \00", align 1
@.str.6 = private unnamed_addr constant [4 x i8] c"%x \00", align 1
@.str.7 = private unnamed_addr constant [10 x i8] c"sensitive\00", section "llvm.metadata"
@.str.8 = private unnamed_addr constant [10 x i8] c"encrypt.c\00", section "llvm.metadata"
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i32 } { i8* bitcast (i8** @key to i8*), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.8, i32 0, i32 0), i32 5 }], section "llvm.metadata"
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0))
  ret void
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i8* %arraydecay)
  %arraydecay2 = getelementptr inbounds [20 x i8], [20 x i8]* %username, i32 0, i32 0
  call void @greeter(i8* %arraydecay2)
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0))
  %arraydecay4 = getelementptr inbounds [1024 x i8], [1024 x i8]* %text, i32 0, i32 0
  %call5 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0), i8* %arraydecay4)
  ...
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i32 0, i32 0))
  store i32 0, i32* @i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0), i32 %conv17)
  br label %for.inc
