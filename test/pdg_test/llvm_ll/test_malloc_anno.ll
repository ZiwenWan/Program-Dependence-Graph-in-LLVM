...
define i32 @main(i32, i8**) #0 {
  ...
  call void @llvm.var.annotation(i8* %7, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 11)
  %8 = call i8* @pz_malloc(i64 4)
