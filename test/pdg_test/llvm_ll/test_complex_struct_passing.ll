...
define void @f(%struct.person_t*) #0 {
  ...
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i8* %15, i8* %16)
  ret void
}
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %5, i8* align 4 getelementptr inbounds (%struct.clothes, %struct.clothes* @__const.main.c, i32 0, i32 0, i32 0), i64 16, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %8, i8* align 1 getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i64 10, i1 false)
