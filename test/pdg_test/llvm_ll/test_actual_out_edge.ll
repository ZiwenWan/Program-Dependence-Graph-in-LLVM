...
define i32 @main() #0 {
  ...
  %7 = bitcast %struct.Person* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* bitcast (%struct.Person* @main.pp to i8*), i64 16, i32 8, i1 false)
  store %struct.Person* %3, %struct.Person** %2, align 8
  %8 = load %struct.Person*, %struct.Person** %2, align 8
  %9 = getelementptr inbounds %struct.Person, %struct.Person* %8, i32 0, i32 0
  %10 = load i32, i32* %9, align 8
  store i32 %10, i32* %4, align 4
  %11 = load i32, i32* %4, align 4
  call void @f(i32 %11)
  %12 = load %struct.Person*, %struct.Person** %2, align 8
  %13 = getelementptr inbounds %struct.Person, %struct.Person* %12, i32 0, i32 0
  %14 = load i32, i32* %13, align 8
  store i32 %14, i32* %5, align 4
  %15 = load i32, i32* %5, align 4
  call void @f(i32 %15)
  %16 = load %struct.Person*, %struct.Person** %2, align 8
