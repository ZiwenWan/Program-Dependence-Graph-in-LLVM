...
@__const.main.b = private unnamed_addr constant %struct.B { i32 5 }, align 4
@__const.main.c = private unnamed_addr constant %struct.C { i32 10 }, align 4
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %5, i8* align 4 bitcast (%struct.B* @__const.main.b to i8*), i64 4, i1 false)
  %6 = bitcast %struct.C* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast (%struct.C* @__const.main.c to i8*), i64 4, i1 false)
