...
define void @_Z2f1iii(i32, i32, i32) #0 {
...
define void @_Z2f2iii(i32, i32, i32) #1 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), i32 %7, i32 %8, i32 %9)
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define void @_Z2f3iii(i32, i32, i32) #1 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
  ...
  %8 = load i32, i32* %5, align 4
  %9 = load i32, i32* %6, align 4
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i32 %7, i32 %8, i32 %9)
  ret void
}
...
define i32 @main() #3 {
  ...
  %2 = alloca void (i32, i32, i32)*, align 8
  store i32 0, i32* %1, align 4
  store void (i32, i32, i32)* @_Z2f2iii, void (i32, i32, i32)** %2, align 8
  %3 = load void (i32, i32, i32)*, void (i32, i32, i32)** %2, align 8
  call void %3(i32 4, i32 5, i32 6)
  ret i32 0
}
