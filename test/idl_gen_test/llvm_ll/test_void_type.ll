...
define void @f() #0 !dbg !8 {
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0)), !dbg !11
  ret void, !dbg !12
}
...
!13 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 7, type: !14, isLocal: false, isDefinition: true, scopeLine: 7, isOptimized: false, unit: !0, variables: !2)
