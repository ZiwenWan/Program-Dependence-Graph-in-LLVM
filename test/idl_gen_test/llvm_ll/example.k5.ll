...
define i32 @main() #0 !dbg !110 {
  ...
  call void @device_reset(i32* getelementptr inbounds (%struct.device, %struct.device* @dev1, i32 0, i32 2)), !dbg !120
  %5 = call %struct.device* @lookup_device(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0)), !dbg !121
  ...
  %8 = call %struct.device* @lookup_device(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0)), !dbg !125
...
define internal void @dev1_open(%struct.device*) #0 !dbg !130 {
  %2 = alloca %struct.device*, align 8
  store %struct.device* %0, %struct.device** %2, align 8
  call void @llvm.dbg.declare(metadata %struct.device** %2, metadata !131, metadata !DIExpression()), !dbg !132
  ...
  store i32 1, i32* %4, align 8, !dbg !135
  ret void, !dbg !136
}
...
define internal void @dev2_open(%struct.device*) #0 !dbg !137 {
  %2 = alloca %struct.device*, align 8
  store %struct.device* %0, %struct.device** %2, align 8
  call void @llvm.dbg.declare(metadata %struct.device** %2, metadata !138, metadata !DIExpression()), !dbg !139
...
!3 = !DIFile(filename: "example.k5.c", directory: "/Users/yongzhehuang/Documents/pdg-projects/pdg-llvm5.0/test/idl_gen_test")
!4 = !{}
!5 = !{!6, !23}
...
!78 = !DILocation(line: 53, column: 14, scope: !71)
...
!120 = !DILocation(line: 101, column: 5, scope: !110)
!121 = !DILocation(line: 103, column: 11, scope: !110)
!122 = !DILocation(line: 103, column: 9, scope: !110)
!123 = !DILocation(line: 104, column: 10, scope: !110)
!124 = !DILocation(line: 104, column: 5, scope: !110)
!125 = !DILocation(line: 105, column: 11, scope: !110)
!126 = !DILocation(line: 105, column: 9, scope: !110)
!127 = !DILocation(line: 106, column: 10, scope: !110)
!128 = !DILocation(line: 106, column: 5, scope: !110)
!129 = !DILocation(line: 108, column: 5, scope: !110)
!130 = distinct !DISubprogram(name: "dev1_open", scope: !3, file: !3, line: 73, type: !15, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!134 = !DILocation(line: 74, column: 7, scope: !130)
!135 = !DILocation(line: 74, column: 29, scope: !130)
!136 = !DILocation(line: 75, column: 1, scope: !130)
!137 = distinct !DISubprogram(name: "dev2_open", scope: !3, file: !3, line: 84, type: !15, scopeLine: 84, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
