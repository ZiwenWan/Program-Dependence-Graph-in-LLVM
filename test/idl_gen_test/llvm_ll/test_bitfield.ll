...
@main.p = private unnamed_addr constant %struct.pack { i8 83, i8 11 }, align 2
...
define i32 @main() #0 !dbg !8 {
  ...
  call void @llvm.dbg.declare(metadata %struct.pack* %2, metadata !12, metadata !25), !dbg !26
  %3 = bitcast %struct.pack* %2 to i8*, !dbg !26
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* getelementptr inbounds (%struct.pack, %struct.pack* @main.p, i32 0, i32 0), i64 2, i32 2, i1 false), !dbg !26
  %4 = bitcast %struct.pack* %2 to i8*, !dbg !27
  %5 = load i8, i8* %4, align 2, !dbg !28
  %6 = and i8 %5, -97, !dbg !28
  %7 = or i8 %6, 96, !dbg !28
  store i8 %7, i8* %4, align 2, !dbg !28
  ret i32 0, !dbg !29
}
...
!8 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 11, type: !9, isLocal: false, isDefinition: true, scopeLine: 11, isOptimized: false, unit: !0, variables: !2)
...
!17 = !DIFile(filename: "/usr/include/i386/_types.h", directory: "/Users/yongzhehuang/Documents/pdg-projects/pdg-llvm5.0/test/idl_gen_test")
